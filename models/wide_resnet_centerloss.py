...
class Wide_ResNet(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes, feature_dim=512):
        ...
        self.linear1 = nn.Linear(nStages[3], feature_dim)
    ...
    def feature_list(self, x):
        ...
        return self.linear2(out), out_list
    ...
    def penultimate_forward(self, x):
        ...
        out = F.avg_pool2d(out, 8)
        out = out.view(out.size(0), -1)
        penultimate = self.linear1(out)
        out = self.linear2(penultimate)
